/*
	This is in here because the SDL library main does some moderately
	dumb things. So this is copy-pasted out of SDL's sources with a few
	defines added. (Specifically, stdio redirect.)
*/
